 ...
 * the contract. Same check every other Aegis engine runs — copied
 * verbatim from aegis-payment-engine so this repo never independently
 * drifts from the platform-wide convention.
 *
