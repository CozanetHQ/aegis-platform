/**
 * POST /api/v2/identity/admin/reactivate
...
export async function POST(request: Request) {
  try {
    ...
    await IdentityEngine.reactivateAccount(auth.userId, body.aegisId, body.reason);
    return ok({ success: true, action: "reactivate", aegisId: body.aegisId });
  } catch (e) {
    return err(e);
  }
}
