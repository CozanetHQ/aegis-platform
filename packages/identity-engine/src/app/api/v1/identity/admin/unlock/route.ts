/**
 * POST /api/v2/identity/admin/unlock
...
export async function POST(request: Request) {
  try {
    ...
    await IdentityEngine.unlockAccount(auth.userId, body.aegisId, body.reason);
    return ok({ success: true, action: "unlock", aegisId: body.aegisId });
  } catch (e) {
    return err(e);
  }
}
