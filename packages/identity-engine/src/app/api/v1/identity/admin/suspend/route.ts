/**
 * POST /api/v2/identity/admin/suspend
...
export async function POST(request: Request) {
  try {
    ...
    await IdentityEngine.suspendAccount(auth.userId, body.aegisId, body.reason);
    return ok({ success: true, action: "suspend", aegisId: body.aegisId });
  } catch (e) {
    return err(e);
  }
}
